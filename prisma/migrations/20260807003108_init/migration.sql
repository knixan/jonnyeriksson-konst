-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('ORIGINAL', 'PRINT');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'ACTIVE');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE', 'SWISH');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID', 'CANCELLED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('NEW', 'PROCESSING', 'SHIPPED');
...
CREATE TABLE "Product" (
    ...
    "type" "ProductType" NOT NULL DEFAULT 'PRINT',
...
CREATE TABLE "ShippingSettings" (
    ...
    "flatRateOre" INTEGER NOT NULL DEFAULT 0,
    "freeShippingThresholdOre" INTEGER,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_size_framed_key" ON "ProductVariant"("productId", "size", "framed");
